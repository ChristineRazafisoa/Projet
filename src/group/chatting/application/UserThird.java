...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        JLabel name = new JLabel("ENI M1");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Christine, Sharon, Chef Scolarité, Sweety, IG Dubey, Shukla");
        ...
        a1 = new JPanel();
        a1.setBounds(3, 75, 440, 570);
        a1.setBackground(Color.white);

        // Ajouter un JScrollPane contenant le JPanel a1
        JScrollPane scrollPane = new JScrollPane(a1);
        scrollPane.setBounds(3, 75, 440, 550);
        f.add(scrollPane);
        ...
        // Création d'une bordure noire autour du JTextArea
        text.setBorder(new LineBorder(Color.BLACK));

        JScrollPane scrollPan = new JScrollPane(text);
        scrollPan.setBounds(5, 630, 300, 50);
        f.add(scrollPan);
        text.append("");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            String out = "<html>" + name + ":" + text.getText() + "</html>";
